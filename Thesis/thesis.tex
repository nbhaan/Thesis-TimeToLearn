...
In this part the implementation choices are described. In this project writing the code was one of the biggest challenges. The code has been changed a lot during the process. One of the reasons was to increase readability, but also because of design changes and new features which had to be implemented. The code is written in JavaScript in combination with HTML 5, this means it is web-based application, more information on this will follow later. In this section we will explain how the code works and how we use a framework to order the code. This framework requirejs makes it possible to have multiple files (modules) in javascript, this to increase readability and structure. This section also explains why certain code decisions have been made.

\subsection{Flash card algorithm}
